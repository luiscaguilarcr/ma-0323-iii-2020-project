...
function GUI_MENU_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = GUI_MENU_OutputFcn(~, ~, handles)
...
% --- Executes on button press in button_DeterminanteMatriz.
function button_DeterminanteMatriz_Callback(hObject, eventdata, handles)
% hObject    handle to button_DeterminanteMatriz (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_GaussJordan.
function button_GaussJordan_Callback(hObject, eventdata, handles)
% hObject    handle to button_GaussJordan (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_Informacion.
function button_Informacion_Callback(hObject, eventdata, handles)
% hObject    handle to button_Informacion (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_Salir.
function button_Salir_Callback(hObject, eventdata, handles)
% hObject    handle to button_Salir (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to button_TrazadorCubico (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in buttton_MetodosNewton.
function buttton_MetodosNewton_Callback(hObject, eventdata, handles)
% hObject    handle to buttton_MetodosNewton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_ReglaCompuestaSimpson.
function button_ReglaCompuestaSimpson_Callback(hObject, eventdata, handles)
