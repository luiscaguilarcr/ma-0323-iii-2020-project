...
% Last Modified by GUIDE v2.5 02-Feb-2021 22:13:52
...
% --- Executes on button press in regresarbutton.
function regresarbutton_Callback(hObject, eventdata, handles)
% hObject    handle to regresarbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
